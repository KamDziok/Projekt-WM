			...
			<div id="content">
				<div id="slogan">
					...
					<div class="inside">
						...
						<div class="wrapper"><a href="#" class="link1"><span><span>Dalej</span></span></a></div>
					</div>
				</div>
				
				<div class="content">
					<h3>W <span>Repertuarze</span></h3>
					<ul class="movies">
						<li>
							...
							<div class="wrapper"><a href="Rezerwacja.php" class="link2"><span><span>Opis i kupno biletu</span></span></a></div>
						</li>
						<li>
...
<!-- FOOTER -->
			<div id="footer">
				<div class="left">
					<div class="right">
						<div class="inside">Copyright - Grupa projektowa nr1 lab2<br />
